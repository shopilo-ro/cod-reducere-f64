#!/usr/bin/env python3
"""
Fetch coduri de reducere F64 de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/f64.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/f64.ro"
STORE_NAME = "F64"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru F64 de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-f64)"
    }
    try:
