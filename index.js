#!/usr/bin/env node
/**
 * Fetch coduri reducere F64 de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/f64.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/f64.ro";
const STORE_NAME  = "F64";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-f64)" }
  });
